                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="text-center " >
                            <h1 class="display-5 text-center text-uppercase mb-4 d-flex">
                                Bid <span class="text-primary">Product Here!!! {params.subcatnm}</span>{" "}
                            </h1></div>
                            ...
                            <div id="categorymain1">
                                {
                                    pList.map((row) => (
                                        ...
                                        <div class="categorypart1 text-center ">
                                            ...
                                            />
                                            <br />
                                            <button type="button" class="btn btn-success rounded-3" onClick={() => handlebidproduct()} >Bid Product</button>
